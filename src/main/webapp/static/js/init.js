...
(function () {
    ...
    as.config(function ($routeProvider, $httpProvider) {
        ...
        $routeProvider.when('/person', { controller: 'PersonController', templateUrl: '/static/view/person.html'});
        $routeProvider.when('/admin', { controller: 'AdminController', templateUrl: '/static/view/admin/admin.html'});
